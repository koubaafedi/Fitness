...
<title>Rent Fitness Equipment</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>HOME FITNESS EQUIPMENT HIRE</h1>
            <p>rent commercial fitness equipment with no contracts and no credit checks </p>
...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      <h2>Find the <span>equipment</span> you need</h2>
      <p>FitnessEquipmentRentals.com has many years of experience servicing Fitness Centers across Tunisia, with clients ranging from small, ten-unit apartment buildings to massive apartment complexes. We stand by our reputation and look forward to helping you create a stellar Fitness Center.</p>
    </div>
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">New Product</a></li>
        </ul>
      </div>
