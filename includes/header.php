    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-3 col-md-2">
          <div class="logo"> <a href="index.php"><img src="assets/images/123.png" alt="image"/></a> </div>
        </div>
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <a href="mailto:info@example.com">fatma.boussarsar.01@gmail.com</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Call Us: </p>
              <a href="tel:61-1234-5678-09">+216-52 313 215</a> </div>
            <div class="social-follow">
              <ul>
                ...
                <li><a href="https://myaccount.google.com/profile"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a></li>
...
echo "Welcome to FitnessEquipmentRentals";
 } ?>
          </div>
        </div>
      </div>
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">Equipment choices</a>
